...
#'
#' @param omicsData an object of the class 'pepData', 'proData', 'metabData', 'lipidData', or 'nmrData', created by \code{\link{as.pepData}}, \code{\link{as.proData}}, \code{\link{as.metabData}}, \code{\link{as.lipidData}}, \code{\link{as.nmrData}}, respectively. Note, if \code{\link{group_designation}} has not been run, the CV is calculated based on all samples for each biomolecule.
#'
...
cv_filter <- function(omicsData){
  ...
  if(!inherits(omicsData, c("pepData", "proData", "lipidData", "metabData", "nmrData"))) stop("omicsData must be an object of class 'pepData', 'proData', 'lipidData', 'metabData', 'nmrData")
