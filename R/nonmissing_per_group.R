...
#  nonmiss_res = dcast(data.table(nonmiss_dat), Peptide~Group, value.var = "non_miss") # this command, using "Peptide", is the reason that we had to set the column name in melt.data to "Peptide" (using cname_id did not work)
