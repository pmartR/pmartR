...
#' nonmissing_result <- nonmissing_per_group(e_data = pep_pepData2$e_data, groupDF = attr(pep_pepData2, "group_DF"), cname_id = attr(pep_pepData2, "cnames")$edata_cname, samp_id = attr(pep_pepData2, "cnames")$fdata_cname)
#'}
#'
