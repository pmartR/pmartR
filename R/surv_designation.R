...
#' @param t_death the column in 'f_data' that corresonds to the subjects' time of death
#' @param t_progress the column in 'f_data' that corresonds to the subjects' time of progression
#' @param ind_death the column in 'f_data' that corresonds to the subjects' status, e.g. alive/dead
#' @param ind_progress the column in 'f_data' that corresonds to the subjects' progression status
#' @param covariates the column(s) in 'f_data' that correspond to covariates to be included in the survivial analysis
#'
