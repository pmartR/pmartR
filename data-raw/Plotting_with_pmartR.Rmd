---
title: "Plotting with the `pmartR` Package"
...
output: 
  rmarkdown::html_vignette:
    ...
    fig_caption: true
vignette: >
  %\VignetteIndexEntry{Analyzing Peptide Data with the pmartR Package}
...
There are two ways to go about normalizing data in the pmartR package. If you know the normalization approach you'd like to use, you can directly specify it in the `normalize_data()` function. Or, if you want to see how compatible different normalization approaches are with your dataset, you can use the `spans()` function [UNDER DEVELOPMENT].
