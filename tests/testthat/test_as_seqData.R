...
test_that('as.seqData returns the correct data frame and attributes',{
  ...
  expect_equal(attr(seqdata, 'cnames'),
               list(edata_cname = 'ID_REF',
                    emeta_cname = NULL,
                    fdata_cname = 'Samples',
                    techrep_cname = NULL))
  ...
  expect_error(as.seqData(e_data = data.frame(edata,
                                              Mock4 = edata[, 10]),
                          f_data = fdata,
                          edata_cname = 'ID_REF',
                          fdata_cname = 'Samples'
  ...
  fdata_1 <- rbind(fdata, data.frame(Samples = 'uterus_PBS_R5', 
                                     Tissue = 'uterus', 
                                     Treatment = 'PBS', 
                                     Label = 'R5'))
  ...
  # an extra row.
  testthat::expect_warning(seqdata <- as.seqData(e_data = edata,
                                     f_data = fdata_1,
                                     edata_cname = 'ID_REF',
                                     fdata_cname = 'Samples'),
  ...
  expect_equal(dim(seqdata$e_data),
               c(1200, 41))
  expect_equal(dim(seqdata$f_data), c(40, 4))
  ...
  expect_error(as.seqData(e_data = edata,
  ...
  seqdata <- as.seqData(e_data = edata_1,
                      f_data = fdata,
                      edata_cname = 'ID_REF',
                      fdata_cname = 'Samples'
                      )
  ...
  testthat::expect_warning(
    as.seqData(e_data = cbind(edata[1], edata[-1]/2),
               edata_cname = 'ID_REF', 
               f_data = fdata, 
               fdata_cname = "Samples"),
  ...
  x <- testthat::expect_message(
    as.seqData(e_data = e_data_temp, 
               edata_cname = 'ID_REF', 
               f_data = fdata, 
               fdata_cname = "Samples")$e_data,
  ...
  expect_error(as.seqData(e_data = 5,
                        f_data = fdata,
                        edata_cname = 'ID_REF',
                        fdata_cname = 'Samples'
  ...
  seqdata <- as.seqData(e_data = data.table::as.data.table(edata),
  ...
  expect_error(as.nmrData(e_data = data.table::as.data.table(edata),
                          f_data = data.table::as.data.table(fdata),
                          e_meta = data.table::as.data.table(emeta),
                          edata_cname = 'ID_REF',
                          fdata_cname = 'Samples',
