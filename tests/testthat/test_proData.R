...
test_that('as.proData returns the correct data frame and attributes',{
  ...
  expect_true(attributes(prdata)$meta_info$meta_data)
  expect_equal(attributes(prdata)$meta_info$num_emeta,
               38)
  ...
  expect_type(attributes(prdata)$filters, 'list')
  ...
  # Inspect the elements of the meta_info attribute.
  expect_false(attributes(prdata)$meta_info$meta_data)
  expect_null(attributes(prdata)$meta_info$num_emeta)
