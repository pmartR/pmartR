...
test_that("incorrect input for edata_id argument throws error",{  
  expect_that(pmartRqc:::rip(e_data = e_data, edata_id = "mass_tag_id", groupDF = groupDF), throws_error())
  expect_that(pmartRqc:::rip(e_data = e_data, edata_id = "abcdefgh", groupDF = groupDF), throws_error())
})
...
test_that("incorrect input for alpha argument throws error",{   
  ...
  expect_that(pmartRqc:::rip(e_data = e_data, edata_id = edata_id, groupDF = group_DF, alpha = -2) , throws_error()) 
})
