...
When working with labeled proteomics data, an `isobaricpepData` object should be used. To perform the reference pool normalization, use the `normalize_isobaric()` function. 
