...
trelli_panel_by(trelliData = trelliData2, panel = "SampleID") %>%
  trelli_missingness_bar(test_mode = TRUE, test_example = 1:10, cognostics = "anova g-test")
```
...
# Statistics data only. Should return total sample proportion, and anova g-test.
trelli_panel_by(trelliData = trelliData3, panel = "Peptide") %>%
  trelli_missingness_bar(test_mode = TRUE, test_example = 1:10, cognostics = c("observed proportion", "anova g-test"))
```
