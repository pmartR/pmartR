...
```{r}
# Should return biomolecule count, and mean, median, cv, and skew abundance
trelli_panel_by(trelliData = trelliData1, panel = "Lipid") %>% 
...
trelli_panel_by(trelliData = trelliData4, panel = "LipidFamily") %>%
  trelli_abundance_heatmap(cognostics = "biomolecule count")

# Should return only mean abundance
trelli_panel_by(trelliData = trelliData4, panel = "LipidFamily") %>%
  trelli_abundance_heatmap(cognostics = "mean abundance")
```
...
trelli_panel_by(trelliData = trelliData1, panel = "Lipid") %>%
  trelli_missingness_bar(test_mode = TRUE, test_example = 1:10, cognostics = "observed sample proportion")
